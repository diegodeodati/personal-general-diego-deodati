...
public class SummaryCasinoV3 implements Serializable {
   ...
   private int ngiorni;
   private int salaChiusa;
   
   private double jkContribution;
   private float vltSum;
   ...
   private int m2;
    ...
    public SummaryCasinoV3(String aamsLocationId, String aamsLocationName, String cciudad, String esercenteName, String gestoreName, 
    		...
    		double AvgCreditsWagPerDayPerVLT, String OpenDate, int VltsZeroes, double RatioVltsZeroes,String Produttori,int ngiorni,
    		int salaChiusa, double jkContribution,float vltSum,int m1, int m2)    
    {
		...
		this.salaChiusa = salaChiusa;
		this.jkContribution = jkContribution;
		this.vltSum = vltSum;
		this.m1 = m1;
		this.m2 = m2;
	}
	...
	public float getVltSum() {
		return vltSum;
	}

	public void setVltSum(float vltSum) {
		this.vltSum = vltSum;
	}

	public double getJkContribution() {
		return jkContribution;
	}

	public void setJkContribution(double jkContribution) {
		this.jkContribution = jkContribution;
	}
	...
	public void setProduttori(String Produttori) {
		this.Produttori = Produttori;
	}
	...
	public int getSalaChiusa() {
		return salaChiusa;
	}

	public void setSalaChiusa(int salaChiusa) {
		this.salaChiusa = salaChiusa;
	}
