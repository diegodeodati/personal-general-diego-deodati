...
public class SummaryCasinoV2 implements Serializable {
   ...
   private double RatioVltsZeroes;
    ...
    public SummaryCasinoV2() {
    	
    }
    
    public SummaryCasinoV2(int LocationID, int CodCasino, String Casino, double MeterIn, double MeterOut, double MeterDrop, int MeterGames,
    		...
    		double AvgCreditsWagPerDayPerVLT, String CCiudad, String OpenDate, int VltsZeroes, double RatioVltsZeroes)    
    {
