...
public class ResultMeterSummaryV2 implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -5431655284602374181L;

    private String aamsVltId;
	private String concesionaireVltId;
    ...
    public ResultMeterSummaryV2() {
    	
    }
    
    public ResultMeterSummaryV2(
    		String aamsVltId,
    	    String concesionaireVltId,
    	    double MeterIn,
    	    double MeterOut,
    	    double MeterDrop,
    	    int MeterGames,
    	    ...
    	    String cabinet)    
     {
        ...
        this.concesionaireVltId = concesionaireVltId;
	...
	public String getConcesionaireVltId() {
		return concesionaireVltId;
	}

	public void setConcesionaireVltId(String concesionaireVltId) {
		this.concesionaireVltId = concesionaireVltId;
	}
