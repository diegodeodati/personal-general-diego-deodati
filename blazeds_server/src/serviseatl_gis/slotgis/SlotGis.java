...
public class SlotGis implements Serializable {
    static final long serialVersionUID = 103849514903090001L;
    ...
    public SlotGis(String CodMaquina, double DenominacionM, int NumMaquina, String NameGame, String NFabricante,  
