...
public class LastPaids implements Serializable {

    static final long serialVersionUID = 103144314222040002L;
    ...
    public LastPaids(String Nombre, String Fecha, String FechaPago, int TimeHours, double RandomWin, int NumMaquina, 
